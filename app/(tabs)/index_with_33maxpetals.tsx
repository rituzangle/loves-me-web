...
import { Download, Github, Settings } from 'lucide-react-native';
...
export default function GameScreen() {
  ...
  const initializeGame = () => {
    // Changed algorithm: now generates 8-33 petals instead of 8-16
    const numPetals = Math.floor(Math.random() * 26) + 8; // Random number from 8 to 33
  ...
  const pluckPetal = (petalId: string) => {
    ...
    if (remainingPetals === 0) {
      ...
      setCurrentPhrase(prev => prev === 'loves-me' ? 'loves-me-not' : 'loves-me');
